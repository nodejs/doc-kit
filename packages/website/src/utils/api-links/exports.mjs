 ...
 * @returns {import('../../generators/api-links/types').ProgramExports | undefined}
 */
function handleExpression(node, basename, nameToLineNumberMap) {
  ...
  /**
   * @type {import('../../generators/api-links/types').ProgramExports}
   */
  const exports = {
    ctors: [],
    identifiers: [],
 ...
 * @param {string} basename
 * @param {Record<string, number>} nameToLineNumberMap
 * @returns {import('../../generators/api-links/types').ProgramExports}
 */
