...
import { buildMetaBarProps } from './barProps.mjs';
import {
  STABILITY_LEVELS,
  LIFECYCLE_LABELS,
  INTERNATIONALIZABLE,
 ...
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry} entry - The metadata entry
 ...
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').HeadingNode} content - The content node to extract text from
 ...
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').StabilityNode} node - The stability node to transform
 ...
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry} entry - The API metadata entry
 * @param {import('unified').Processor} remark - The remark processor
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').HeadingNode} node - The heading node to transform
 * @param {number} index - The index of the node in its parent's children array
 ...
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry} entry - The API metadata entry to process
 * @param {import('unified').Processor} remark - The remark processor
 */
 ...
 * @param {Array<import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry>} entries - API documentation metadata entries
 * @param {ReturnType<import('./barProps.mjs').buildSideBarProps>} sideBarProps - Props for the sidebar component
...
/**
 * @typedef {import('estree').Node & { data: import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry }} JSXContent
 *
 * Transforms API metadata entries into processed MDX content
 * @param {Array<import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry>} metadataEntries - API documentation metadata entries
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry} head - Main API metadata entry with version information
