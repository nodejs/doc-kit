...
import { parseListItem } from '@doc-kittens/legacy/src/utils/json/list.mjs';
import parseSignature from '@doc-kittens/legacy/src/utils/json/signature.mjs';
 ...
 * @param {import('@doc-kittens/legacy/src/generators/json/types').MethodSignature} signature - The parsed signature object.
 ...
 * @param {import('@doc-kittens/legacy/src/generators/json/types').MethodSignature} signature - Signature object with parameter and return type info.
 ...
 *
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').HeadingData} heading - Metadata with name and text fields.
 ...
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').HeadingNode} heading - The heading node with metadata.
