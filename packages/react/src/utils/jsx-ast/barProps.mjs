 ...
 *
 * @param {Array<import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry>} entries - API documentation entries
 */
 ...
 *
 * @param {Array<import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry>} entries - All API metadata entries
 */
 ...
 *
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry} head - Main API metadata entry (used as reference point)
 * @param {Array<import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry>} entries - All documentation entries for a given API item
 */
 ...
 *
 * @param {Array<import('#core/parsers/types').ReleaseEntry>} compatibleVersions - Compatible versions
 ...
 *
 * @param {import('@doc-kittens/internal/src/generators/metadata/types').MetadataEntry} entry - Current documentation entry
