 ...
 *
 * @param {Array<import('../jsx-ast/content.mjs').JSXContent>} entries - JSX AST entries
 ...
 *
 * @param {Array<import('../jsx-ast/content.mjs').JSXContent>} entries - The JSX AST entry to process.
