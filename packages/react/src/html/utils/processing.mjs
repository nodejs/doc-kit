 ...
 *
 * @returns {{ add: (item: { data: import('@node-core/doc-kit/generators/metadata/types').MetadataEntry, code: string }) => void, serverCodeMap: Map<string, string>, clientCodeMap: Map<string, string> }}
 */
 ...
 * @param {Array<import('@node-core/doc-kit/generators/metadata/types').MetadataEntry>} params.datas - Per-page metadata, in render order.
