...
import { parseTypedList } from './list.mjs';
 ...
 */
export const findParent = (entry, entries, startIdx) => {
...
/**
 * @returns {(head: import('../../../metadata/types').MetadataEntry, entries: import('../../../metadata/types').MetadataEntry[]) => import('../../types.d.ts').ModuleSection}
 */
