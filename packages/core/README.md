...
`bootstrap` sets a project up end to end (configuration file, documentation
directory, generator packages); `serve` builds the site, serves it locally,
and rebuilds as you edit. See the
[documentation](https://doc-kit-docs.vercel.app/) for the full guide.
