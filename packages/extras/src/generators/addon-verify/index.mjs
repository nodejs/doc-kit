...
import { EXTRACT_CODE_FILENAME_COMMENT } from '../../utils/addon-verify/constants.mjs';
import { generateFileList } from '../../utils/addon-verify/fileList.mjs';
import {
  generateSectionFolderName,
  isBuildableSection,
  normalizeSectionName,
} from '../../utils/addon-verify/section.mjs';
