...
export const createSectionBuilder = () => {
   ...
   * @param {import('@doc-kit/core/generators/metadata/types').MetadataEntry} entry - The entry to create metadata from.
   ...
   * @param {import('@doc-kit/core/generators/metadata/types').MetadataEntry} entry - The AST entry.
   * @param {import('@doc-kit/core/generators/metadata/types').HeadingNode} head - The head node of the entry.
   ...
   * @param {import('@doc-kit/core/generators/metadata/types').MetadataEntry} entry - The entry providing stability information.
   */
   ...
   * @param {import('../types.d.ts').Section} section - The section to update.
   * @param {import('../types.d.ts').Section} parent - The parent section.
   * @param {import('@doc-kit/core/generators/metadata/types').HeadingNode} heading - The heading node of the section.
   */
